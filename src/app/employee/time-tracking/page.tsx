...
import TimeTrackingSystem from '@/components/employee/TimeTrackingSystem'
...
export default function EmployeeTimeTrackingPage() {
  ...
  // Mock current user for the time tracking system
  const currentUser = {
    id: session.user.id,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <main className="py-8 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Time Tracking</h1>
            <p className="mt-3 text-lg text-gray-600 font-medium">
              Track your work hours and manage time entries
            </p>
          </div>
          <TimeTrackingSystem currentUser={currentUser} />
        </div>
      </main>
    </div>
  )
