...
export const mockEmployeeEnrollments: EmployeeBenefitEnrollment[] = [
  {
    ...
    selectedPlans: [mockBenefitPlans[0], mockBenefitPlans[2]], // Standard Medical, Basic Dental
    dependents: [mockDependents[0], mockDependents[1]],
    totalMonthlyCost: 350.00 + 45.00 + (mockBenefitPlans[0].premium * 0.5) + (mockBenefitPlans[2].premium * 0.5), // Example calculation
    status: 'submitted',
  ...
  },
  {
    ...
    selectedPlans: [mockBenefitPlans[1], mockBenefitPlans[3], mockBenefitPlans[4]], // Premium Medical, Vision, Life
    dependents: [mockDependents[0]],
    totalMonthlyCost: 550.00 + 20.00 + 30.00 + (mockBenefitPlans[1].premium * 0.5) + (mockBenefitPlans[3].premium * 0.5) + (mockBenefitPlans[4].premium * 0.5), // Example calculation
    status: 'draft',
